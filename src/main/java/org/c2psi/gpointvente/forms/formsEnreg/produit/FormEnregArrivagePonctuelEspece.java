...
public class FormEnregArrivagePonctuelEspece implements java.io.Serializable {
    ...
    public FormEnregArrivagePonctuelEspece() {
    }

    public FormEnregArrivagePonctuelEspece(String dateheurelivraisonArrivage, double prixachatunitaire, String dateperemption, String dateseuilperemption, int quantitelivree, String idproduitFormateUnite, String idPointvente) {
